...
public static class GetProfilesByUser
{
    public sealed record Query() : IRequest<List<ProfileDto>>;

    public sealed class Handler : IRequestHandler<Query, List<ProfileDto>>
    {
